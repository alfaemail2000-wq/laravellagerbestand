<div>
    <h2 class="text-xl font-bold mb-4">Wareneingang buchen</h2>
    ...
    <form wire:submit.prevent="submit" class="mb-6 space-y-4">
        ...
        <button type="submit" class="bg-blue-500 text-white px-3 py-1 rounded">Buchen</button>
    </form>

    <h3 class="text-lg font-semibold mb-2">Letzte Wareneingänge</h3>
    <table class="w-full border">
        <thead>
        <tr class="bg-gray-100">
            <th class="border p-1">Artikel</th>
            <th class="border p-1">Lager</th>
